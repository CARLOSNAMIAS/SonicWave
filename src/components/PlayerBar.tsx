      ...
      <div className={`fixed inset-0 z-[70] bg-sonic-darker transition-all duration-700 ease-in-out transform ${isExpanded ? 'translate-y-0' : 'translate-y-full'}`}>
        ...
        <div className="h-full flex flex-col p-6 relative">
          ...
          <div className="flex-1 flex flex-col items-center justify-center space-y-12">
            <div className={`w-80 h-80 rounded-3xl overflow-hidden shadow-[0_32px_64px_-12px_rgba(34,211,238,0.3)] transition-all duration-1000 transform ${isPlaying ? 'scale-100 rotate-0' : 'scale-90 rotate-2 opacity-50'}`}>
              <img 
